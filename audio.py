...
class AudioTab(QWidget):
    ...
    def init_ui(self):
        ...
        quality_layout.addWidget(QLabel("Format Audio:"))
        
        self.quality_label = QLabel("MP3 - Kualitas Terbaik (format 140)")
        self.quality_label.setStyleSheet("color: #a6e3a1; font-weight: bold;")
    ...
    def download_audio(self):
        ...
        self.download_btn.setEnabled(False)
        self.log_output.append("🚀 Memulai download MP3...")
    ...
    def on_download_finished(self):
        self.progress_bar.setVisible(False)
        self.download_btn.setEnabled(True)
        self.log_output.append("✅ Download MP3 selesai!")
        
        QMessageBox.information(self, "Sukses", "Download MP3 berhasil!")
